          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignUp}>
              ...
              <div className="animate-element animate-delay-700">
                <label className="text-sm font-medium text-white/90">Código de Autenticação</label>
                <GlassInputWrapper>
                  <input name="authCode" type="text" placeholder="Digite o código de autenticação" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none text-white placeholder-white/60" required />
                </GlassInputWrapper>
              </div>

              <div className="animate-element animate-delay-800 flex items-center text-sm">
              ...
              <button type="submit" className="animate-element animate-delay-900 w-full rounded-2xl bg-white/10 text-white py-4 font-medium hover:bg-white/20 transition-colors">
                Criar Conta
              </button>
            </form>
            ...
            <button onClick={onGoogleSignUp} className="animate-element animate-delay-1100 w-full flex items-center justify-center gap-3 border border-white/20 rounded-2xl py-4 hover:bg-white/10 text-white transition-colors">
                <GoogleIcon />
                Cadastrar com Google
            </button>

            <p className="animate-element animate-delay-[1200ms] text-center text-sm text-white/70">
